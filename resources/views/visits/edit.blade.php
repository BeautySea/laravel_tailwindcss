                        ...
                        <div>
                            <div class="flex justify-center flex-wrap space-x-4">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" value="{{$visit->email}}"
                                ...
                                <div>
                                    ...
                                    <select id="energy" name="energy" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($visit->energy==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <!-- Energy Select -->
                                <div>
                                    ...
                                    <select id="pain" name="pain" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($visit->pain==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <!-- Body Discomfort -->
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="where_is_pain" rows="8" name="where_is_pain"
                                        ...
                                        placeholder="Your description here">{{$visit->where_is_pain}}</textarea>
                                </div>
                                <div>
                                    <label for="anxiety"
                                    ...
                                    <select id="anxiety" name="anxiety" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($visit->anxiety==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="main_complaint" rows="8" name="main_complaint"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Your description here">{{$visit->main_complaint}}</textarea>
                                </div>
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="general_note" rows="8" name="general_note"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Your description here">{{$visit->general_note}}</textarea>
                                </div>
