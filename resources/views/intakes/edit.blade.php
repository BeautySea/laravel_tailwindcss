                        ...
                        <div>
                            <div class="flex justify-center flex-wrap space-x-4">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" value={{$intake->email}}
                                ...
                                <div>
                                    ...
                                    <select id="energy_level" name="energy_level" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($intake->energy_level==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <!-- Energy Select -->
                                <div>
                                    ...
                                    <select id="stress_level" name="stress_level" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($intake->stress_level==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <!-- Body Discomfort -->
                                <div>
                                    ...
                                    <select id="body_discomfort" name="body_discomfort" required
                                        ...
                                        @for ($i = 1; $i <= 10; $i++)
                                            <option value="{{$i}}" @if($intake->body_discomfort==$i) selected @endif>level{{$i}}</option>
                                        @endfor
                                    </select>
                                </div>
                                <!-- Weight Input -->
                                <div>
                                    ...
                                    <input type="text" name="weight" id="weight" value="{{$intake->weight}}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
